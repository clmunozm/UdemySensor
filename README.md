...
(For configuring the bGames cloud module, you can check the following repository: 
* [bGames-dev-services]([https://docs.docker.com/get-docker/](https://github.com/BlendedGames-bGames/bGames-dev-services/))
